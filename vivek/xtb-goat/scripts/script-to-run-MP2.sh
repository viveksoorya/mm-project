for j in l ; do
	for dir in xtb-goat/${j}/${j^^}_CONF; do
		...
		for conformer in 0 1 2 3 4 5; do
			...
			echo -e "! MP2 6-31G** \n\n* xyzfile 0 1 /home/vivek/mm-project/vivek/xtb-goat/${dir}/${conformer}.xyz" > /home/vivek/mm-project/vivek/xtb-goat/MP2/${j}/${conformer}/${conformer}.inp
			cd /home/vivek/mm-project/vivek/xtb-goat/MP2/${j}/${conformer}/
