for j in d g k ; do
	...
	#		echo -e "! B97-D 6-31G** \n\n* xyzfile 0 1 /home/vivek/mm-project/vivek/${dir}/${conformer}.xyz" > /home/vivek/mm-project/vivek/B97\-D/${j}/${conformer}/${conformer}.inp
			cd /home/vivek/mm-project/vivek/B97\-D/${j}/${conformer}/
